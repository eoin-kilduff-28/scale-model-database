...
const scaleDescriptions = {
    "1:1": "Life sized models, most are small enough to display on a shelf.",
    "1:8": "Large scale model sets with incredible detail, not recommended for beginners."
};
...
if(list){
    ...
    allScale.forEach(function(scale) {
        ...
        const descriptions = scaleDescriptions[scale] || "A range of scale models for manufacturers.";
        card.innerHTML = `
